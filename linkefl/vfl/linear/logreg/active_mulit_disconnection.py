...
from linkefl.common.factory import crypto_factory, logger_factory, messenger_factory,messenger_factory_multi_disconnection
...
if __name__ == '__main__':
    ...
    active_party = ActiveLogReg_disconnection(epochs=_epochs,
