...
if __name__ == '__main__':
    ...
    if u_shape_flag == True:  # U-Shape split learning
        ...
        if model_name == 'lenet5':
            ...
            client_model, top_model = SplitVGG(model_name, _out_layer=_split_layer[0]), None
        else:
            raise ValueError('Invalid model name.')
        client_opt, top_opt = torch.optim.SGD(client_model.parameters(), lr=_learning_rate), None
