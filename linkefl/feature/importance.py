...
#             model.fit(
#                 active_trainset.features,
#                 active_trainset.labels,
#                 eval_metric='logloss'
#             )
#         else:
#             model = XGBClassifier()
...
def cached_permutation(dataset_name, measurement="xgboost"):
    ...
    if dataset_name == "cancer":
        ...
        if measurement == "xgboost":
            ...
            _permutation = np.array([5, 7, 1, 6, 8, 0, 9, 3, 2, 4])
        ...
        if measurement == "xgboost":
            _permutation = np.array([8, 2, 3, 7, 9, 1, 6, 5, 4, 0])
        else:
            _permutation = np.array([8, 2, 3, 0, 6, 9, 5, 1, 4, 7])
