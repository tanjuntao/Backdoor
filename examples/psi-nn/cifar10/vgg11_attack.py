...
if __name__ == "__main__":
    ...
    bottom_model = TorchModelIO.load("../models/cifar10_vgg11", "VFL_active.model")[
        "model"
    ]["bottom"].to(_device)
    bottom_model.feature_extractor[0] = nn.Conv2d(
        3, 64, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)
    ).to(_device)
    bottom_model.feature_extractor[4] = nn.Conv2d(
        64, 128, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)
    ).to(_device)
    bottom_model.feature_extractor[8] = nn.Conv2d(
        128, 256, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)
    ).to(_device)
    bottom_model.feature_extractor[11] = nn.Conv2d(
        256, 256, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)
    ).to(_device)
    bottom_model.feature_extractor[15] = nn.Conv2d(
        256, 512, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)
    ).to(_device)
    bottom_model.feature_extractor[18] = nn.Conv2d(
        512, 512, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)
    ).to(_device)
    bottom_model.feature_extractor[22] = nn.Conv2d(
        512, 512, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)
    ).to(_device)
    bottom_model.feature_extractor[25] = nn.Conv2d(
        512, 512, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)
    ).to(_device)

    # bottom_model.feature_extractor[11].weight.data[:bottom_model.feature_extractor[11].weight.shape[0]//2] = torch.rand(bottom_model.feature_extractor[11].weight.shape[0]//2, bottom_model.feature_extractor[11].weight.shape[1], 3, 3) * 2 - 1
