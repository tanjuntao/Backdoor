...
def vis_resnet18(importance_records, cummulated=True):
    fig = plt.figure()
    ...
    ax.plot(x_epochs, conv1, label="layer1")
    ax.plot(x_epochs, layer1_0_conv1, label="layer2")
    ax.plot(x_epochs, layer1_0_conv2, label="layer3")
    ax.plot(x_epochs, layer1_1_conv1, label="layer4")
    ax.plot(x_epochs, layer1_1_conv2, label="layer5")
    ax.plot(x_epochs, layer2_0_conv1, label="layer6")
    ax.plot(x_epochs, layer2_0_conv2, label="layer7")
    ax.plot(x_epochs, layer2_1_conv1, label="layer8")
    ax.plot(x_epochs, layer2_1_conv2, label="layer9")
    ax.plot(x_epochs, layer3_0_conv1, label="layer10")
...
def vis_vgg13(importance_records, cummulated=True):
    fig = plt.figure()
    # fig = plt.figure(figsize=(6,5))
    ax = fig.add_subplot(1, 1, 1)
    x_epochs = list(range(50))
    ...
    ax.plot(x_epochs, layer1, label="layer1")
    ax.plot(x_epochs, layer2, label="layer2")
    ax.plot(x_epochs, layer3, label="layer3")
    ax.plot(x_epochs, layer4, label="layer4")
    ax.plot(x_epochs, layer5, label="layer5")
    ax.plot(x_epochs, layer6, label="layer6")
    ax.plot(x_epochs, layer7, label="layer7")
    ax.plot(x_epochs, layer8, label="layer8")
    ax.plot(x_epochs, layer9, label="layer9")
    ax.plot(x_epochs, layer10, label="layer10")
...
if __name__ == "__main__":
    vis_resnet18(loading(name="resnet18"), cummulated=True)
    vis_vgg13(loading(name="vgg13"), cummulated=True)
